...
public class SmartMazeCell {
	...
	public SmartMazeCell() {
	}
	
	public SmartMazeCell(int x, int y) {
		this.x = x;
		this.y = y;
	}
	public SmartMazeCell(boolean hasNorthWall, boolean hasSouthWall, boolean hasEastWall, boolean hasWestWall, int x, int y) {
	...
	public SmartMazeCell(boolean hasNorthWall, boolean hasSouthWall, boolean hasEastWall, boolean hasWestWall) {
		wallMap = new HashMap<String,Boolean>();
		wallMap.put("North", new Boolean(hasNorthWall));
		wallMap.put("South", new Boolean(hasSouthWall));
		wallMap.put("East", new Boolean(hasEastWall));
